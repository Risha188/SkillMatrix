...
const getAdminDashboard = async (req, res) => {
    try {
        ...
        const inactiveEmployeesCount = await User.countDocuments({
            role: "employee",
            isActive: false
        });
        ...
        const inactiveEmails = inactiveUsers.map(
            (user) => user.email
        );
        ...
        const inactiveEmployeeMap = new Map(
        ...
        const inactiveEmployees = inactiveUsers.map(
            (user) => {
